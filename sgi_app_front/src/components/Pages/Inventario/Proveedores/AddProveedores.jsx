...
const AddProveedores = (props) => {
  const { proveedores = [], setOpen = () => null, refresh } = props;
  ...
  const onRegistro = () => {
    ...
    for (let require of required) {
      if (
        !nuevoProveedor[require] ||
        nuevoProveedor[require] === "" ||
        nuevoProveedor[require] === "empty"
      ) {
    ...
    if (cancel) return;
      ...
      axiosClient
        .post("/proveedor", { proveedor: nuevoProveedor })
        .then(({ data }) => {
          refresh();
  ...
  return (
    <div className="containerRight">
      ...
      <button onClick={onRegistro} className="btnAgregarRight vw30">
